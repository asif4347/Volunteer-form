...
<body>
	...
	<!-- Must Delete in search2.php  yahan se le k -->
	
	<form action="delete.php" style="position:absolute; z-index:1; margin:150px 0px 0px 61%;" method="post">
		ID: <input type="text" style="width:100px;" name="del"/>
